...
public class AuthController {
    ...
    public AuthResponse registerOwner(@Valid @RequestBody RegisterRequest request) { return service.registerOwner(request); }
    @PostMapping("/register-player") @ResponseStatus(HttpStatus.CREATED)
    public AuthResponse registerPlayer(@Valid @RequestBody RegisterRequest request) { return service.registerPlayer(request); }
